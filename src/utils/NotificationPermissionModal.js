...
const NotificationPermissionModal = () => {
  ...
  async function getReminderTimestamp() {
    try {
      ...
      return doc.exists && Object.prototype.hasOwnProperty.call(doc.data(), "remindNotification")
        ? doc.data().remindNotification.toDate()
        : null;
    } catch {
      return null; // offline and no cache — just don't show the modal
    }
  }
